...
with open(r'C:\Users\gabri\Desktop\prospector\server\src\routes\contracts.js', 'w', encoding='utf-8') as f:
    f.write(code)
print(f'contracts.js: {len(open(r"C:\Users\gabri\Desktop\prospector\server\src\routes\contracts.js", encoding="utf-8").readlines())} lines')
